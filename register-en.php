...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (userExist($pdo, $_POST['login'], $_POST['email']) === true) {
    $errmsg .= "The user with this e-mail / login already exists.</p>";
  }
      ...
      <div class="">
        <div class="row">
          <div class="col-xs-6"><label for="firstname">
              <input type="text" id="meno" class="form-control" name="firstname" value="" id="firstname" placeholder="Enter first name" required>
            </label></div>
          <div class="col-xs-6"><label for="lastname">
              <input type="text" id="priezvisko" class="form-control" name="lastname" value="" id="lastname" placeholder="Enter last name" required>
            </label></div>
        </div>
      </div>
      <div class="form-group">
        <label for="email">
          <input type="email" class="form-control" name="email" value="" id="email" placeholder="Enter email" required>
        </label>
      </div>
      <div class="form-group">
        <label for="login">
          <input type="text" class="form-control" name="login" value="" id="login" placeholder="Enter username" required>
        </label>
      </div>
      <div class="form-group">
        <label for="password">
          <input type="password" class="form-control" name="password" value="" id="zadah heslo" placeholder="Enter password" required>
        </label>
      </div>
      <div class="form-group">
